...
**3. Record the verdict** on the same iteration, as the last line: `**Verdict:** PASS`, or `**Verdict:** BLOCK` followed by what failed and why. A plan you wrote, worked through, and passed clean is the whole result; you do not reach past it for more to say. State an observation if one is worth stating, but never a recommendation — what to do about anything is the Supreme Commander's. The moment you reach "you should," you have stopped verifying and started routing.
