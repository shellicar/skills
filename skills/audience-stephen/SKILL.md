---
name: audience-stephen
description: |
  WHAT: How Stephen the person reads — cold, across dozens of threads, in seconds — and the pass that cuts a reply to what he needs to act.
  WHY: His time is the resource to protect. And "be brief" does not work — the trained "produce the full account" target fires when you finish work and writes the wall anyway. Only a pass that cuts its output holds.
  WHEN: Whenever Stephen is a reader of the output.
...
# Audience: Stephen the person

He is not watching this arrive. He started the thread and left; he comes back in minutes, or a day, cold, with none of it in his head — across dozens of threads at once. His time is the one resource to protect. What you write for him is measured by one thing: how fast he can act on it.

## The win

Not a thorough report. He reads once, in seconds, and can act — because you did the understanding and handed him only what needs him.
...
So the discipline is a mechanical pass. Here you cut what he would wade through.
...
- **The full account.** Every check and every finding is more to wade through before he can act.
