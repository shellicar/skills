...
name: medium-pr
description: |
  WHAT: PR titles and descriptions that communicate what changed, scannable in one pass.
...
The PR's primary readers are reviewers; secondary is the team reading PR history and the traceability record — technical readers (`audience-developer`). The voice composes at load.
